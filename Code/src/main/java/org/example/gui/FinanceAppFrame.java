...
public class FinanceAppFrame extends JFrame {
    ...
    private JPanel createFinancialPlanTab() {
        ...
        JLabel todo = new JLabel("TODO: Implement Financial Plan UI and data connections");
        todo.setFont(primaryFont(Font.ITALIC, 14));
        todo.setForeground(COLOR_TEXT_SECONDARY);
        todo.setHorizontalAlignment(SwingConstants.CENTER);

        center.add(todo, BorderLayout.CENTER);
